from classes.games import Person, bcolors
...
player_spells = [fire, thunder, blizzard, meteor, cura, cura]
player_items = [
...
enemy = Person("Eny", 1200, 65, 45, 25, [], [])
...
while running:
    ...
    print("Your MP:", bcolors.OKBLUE + str(player.get_mp()) + bcolors.ENDC + "\n")
